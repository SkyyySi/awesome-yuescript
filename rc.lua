...
local function lookup_icon(icon_name)
...
local function lookup_gicon(gicon)
	if not gicon then
		return
	end

	-- If the gicon is already a path string
	if type(gicon) == "string" then
		return gicon
	end
...
local function gen_app_menu()
	local all_apps = {
		{ "Multimedia",  {}, lookup_icon("applications-multimedia") },
		...
		{ "Utilities",   {}, lookup_icon("applications-utilities") },
		{ "Other",       {}, lookup_icon("applications-other") },
	}
	...
	local function create_menu_entry_for_app(app_info)
		return {
			app_info:get_name(),
			function() app_info:launch() end,
...
myawesomemenu = {
	{ "Hotkeys", function() hotkeys_popup.show_help(nil, awful.screen.focused()) end, lookup_icon("input-keyboard-symbolic") },
	{ "View manual", (terminal .. " -e man awesome"), lookup_icon("help-info-symbolic") },
	{ "Edit config", (editor_cmd .. " " .. awesome.conffile), lookup_icon("edit-symbolic") },
	{ "Restart awesome", function() awesome.restart() end, lookup_icon("system-restart-symbolic") },
	{ "Quit awesome", function() awesome.quit() end, lookup_icon("exit") },
}

mymainmenu = awful.menu {
	items = {
		{ "Awesome",  myawesomemenu,  beautiful.awesome_icon },
		{ "Apps",     gen_app_menu(), lookup_icon("applications-all") },
		{ "Terminal", terminal,  lookup_icon("terminal") },
		{ "Browser",  function() Gio.AppInfo.launch_default_for_uri("https://") end, lookup_icon("browser") },
	}
}
